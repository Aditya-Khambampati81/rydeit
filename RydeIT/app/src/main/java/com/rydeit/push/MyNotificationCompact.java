 ...
 */
public class MyNotificationCompact {
    ...
    private static final MyNotificationCompactImpl IMPL;

    interface MyNotificationCompactImpl {
        public Notification build(Builder b);
    }

    static class NotificationCompatImplBase implements  MyNotificationCompactImpl {
        @Override
        public Notification build(Builder b) {
    ...
    static class NotificationCompatPostJellyBean implements MyNotificationCompactImpl {
